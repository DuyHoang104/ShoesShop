...
namespace ShoesShop.Domain.Services.Users.Services;
...
public class UserService : IUserService
{
    ...
    public async Task<GetAllInfoUsersQuery> GetAllInfoUsersAsync(int userId)
    {
        ...
        return new GetAllInfoUsersQuery
        {
            ID = user.Id,
