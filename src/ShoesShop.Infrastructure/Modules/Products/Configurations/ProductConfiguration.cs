...
public class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        builder.Property(p => p.Price).HasField("_price").HasPrecision(18, 2).IsRequired();
        builder.Property(p => p.Quantity).HasField("_quantity").IsRequired();
        builder.Property(p => p.SaleOff).HasField("_saleOff").HasPrecision(5, 2).IsRequired(false);
