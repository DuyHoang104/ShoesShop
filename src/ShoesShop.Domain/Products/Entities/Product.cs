...
namespace ShoesShop.Domain.Products.Entities;
...
public class Product : EntityAuditLog<int>
{
    ...
    public Product(string name, string description, decimal price, string brand, string color, int quantity, 
        decimal? saleOff, ProductStatus? status, string sizes)
    {
        Name = name;
