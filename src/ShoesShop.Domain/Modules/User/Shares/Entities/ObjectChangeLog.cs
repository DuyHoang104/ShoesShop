...
using ShoesShop.Domain.Modules.User.Shares.Enums;

namespace ShoesShop.Domain.Modules.User.Shares.Entities;
public class ObjectChangeLog : BaseEntity<int>
{
    ...
    public ObjectChangeLog(EntityName entityName, string propertyName, int keyValue, string? oldValue, string? newValue, DateTime changeDate, ShoesShop.Domain.Modules.User.Users.Entities.User user)
    {
