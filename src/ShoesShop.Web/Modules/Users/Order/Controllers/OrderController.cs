...
namespace ShoesShop.Web.Modules.Users.Order.Controllers;
[Route("Order")]
...
public class OrderController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        return View("~/Modules/Users/Order/Views/Index.cshtml", ordermodalDto);
    }
    ...
    public async Task<IActionResult> Checkout()
    {
        ...
        return View("~/Modules/Users/Order/Views/Checkout.cshtml", orderModelDto);
    }
    ...
    public async Task<IActionResult> Success(int orderId)
    {
        ...
        return View("~/Modules/Users/Order/Views/Success.cshtml", orderDetail);
    }
    ...
    public IActionResult Fail(string vnp_ResponseCode)
    {
        ...
        return View("~/Modules/Users/Order/Views/Fail.cshtml");
    }
    ...
    public async Task<IActionResult> Chat(int orderId)
    {
        var userId = GetCurrentUserId();
        if (userId == 0) return Unauthorized();
        var order = await _orderService.GetUserInfoForOrderAsync(userId, orderId);
        ...
        return View("~/Modules/Users/Order/Views/Chat/index.cshtml", chatDto);
    }
}